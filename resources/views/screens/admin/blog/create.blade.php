    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col col-lg-8">
                ...
                <form action="{{ route('admin.blog.store') }}" method="post" class="mt-4"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mt-3">
                        <label for="name" class="form-label">Blog Name:</label>
                        <input type="text"
                            class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" name="name" id="name">
                        @error('name')
                    ...
                    <div class="mt-5">
                        <input type="submit" value="Add Blog" class="btn btn-primary col-lg-12" name=""
                            id="">
                    </div>
